...
class _MapPageState extends State<MapPage> {
  ...
  void _buildRouteToDestination() async {
    if (_currentLocation == null ||
        ...
        widget.destinationLongitude == null) return;
  ...
  void _getCurrentLocation() async {
    ...
    try {
      ...
      setState(() {
        ...
        _navigationOption.initialLongitude = position.longitude;
        _navigationOption.initialLatitude = position.latitude;
      });
    } catch (e) {
  ...
  Future<void> _addMarkers() async {
    ...
    LatLng currentLocation =
        _currentLocation ?? const LatLng(10.759091, 106.675817);
  ...
  void _deleteDestination() async {
    ...
    await _navigationController
        ?.removeAllMarkers(); // Remove all markers, if available
