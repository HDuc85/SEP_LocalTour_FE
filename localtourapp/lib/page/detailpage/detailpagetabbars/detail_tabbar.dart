...
import 'package:localtourapp/page/detailpage/placedescription.dart';
                  ...
                  showDialog(
                    ...
                    builder: (BuildContext context) {
                      return ActivityFormDialog(
                        ...
                        priceType: activityCardInfo.priceType,
                        discount: activityCardInfo.discount,
                        description: activityCardInfo.description, // Pass actual description
                        mediaActivityList: mediaActivityList, // Pass filtered media
                      );
                    },
                  );
                },
