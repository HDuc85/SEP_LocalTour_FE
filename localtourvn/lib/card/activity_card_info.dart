...
List<ActivityCardInfo> getActivityCards(int placeId, List<PlaceActivity> activities, List<PlaceActivityTranslation> placeActivityTranslations, List<PlaceActivityMedia> placeActivityMedias) {
  ...
  List<ActivityCardInfo> activityCards = activities
    ...
    PlaceActivityTranslation placeActivityTranslation = placeActivityTranslations.firstWhere(
    ...
    PlaceActivityMedia placeActivityMedia = placeActivityMedias.firstWhere(
      ...
      orElse: () => PlaceActivityMedia(
        ...
        placeActivityId: activity.id,
        type: 'photo',
        url: 'https://via.placeholder.com/150',  // Default placeholder image
        createDate: DateTime.now(),
      ),
    );

    return ActivityCardInfo(// Add media ID here
      placeActivityId: activity.id,
